...
print('{} tem {} anos e um imc de {:.3f}'.formatacao(nome,idade,imc))  # variaveis são utilizadas na ordem, pas fstring
print('{1} tem {2} anos e um imc de {0}'.formatacao(nome,idade,imc))  # msm coisa mas segue ordem dada nas {}
print('{a} tem {b} anos e um imc de {c}'.formatacao(a=nome,b=idade,c=imc))
