...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Martin')
        self.setFixedSize(400, 400)
        self.cw = QWidget()
        self.grid = QGridLayout(self.cw)

        self.display = QLineEdit()
        self.grid.addWidget(self.display, 0, 0, 1, 5)  # objeto, na 1ra linha, 1ra coluna, tamnho 1linh, uma coluna
        ...
        self.add_btn(QPushButton('<-'), 2, 4, 1, 1,
                     ...
                     'background: #30a638; color: #FFF; font-weight: 700;'
                     )
        ...
        self.add_btn(QPushButton('='), 3, 4, 1, 1, self.eval_igual,
    ...
    def eval_igual(self):
        try:
            self.display.setText(str(eval(self.display.text())))  # eval faz o calculo igual Python faz
