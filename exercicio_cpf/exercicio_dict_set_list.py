...
# Minha solução (não completa)
# def duplicados(lista):
#     ocorrencia = 0
#     for testado in lista:
#         for numero in lista:
#             if numero == testado:
#                 ocorrencia += 1
#
...
#
# L=[]
# for lista_test in lista_de_listas_de_inteiros:
#     dupl = (duplicados(lista_test))
#     L+= [dupl]
#
#
# print(L)
...
def encontra_primeiro_duplicado(param_lista_de_inteiros):
    ...
    for numero in param_lista_de_inteiros:
        ...
        if numero in numero_checados:  # compara com o que JA PASSOU, nao com o q tem na lista
            primeiro_duplicado = numero
            break  # sai do for,
        numero_checados.add(numero) # coloca todos os numeros no set para dizer 'JA PASSOU' e comparar depois
